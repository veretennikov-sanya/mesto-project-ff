...
const editProfileFormBtn = formElementProfile.querySelector(".popup__button");
const cardFormBtn = formElementCard.querySelector(".popup__button");
const avatarFormBtn = formElementAvatar.querySelector(".popup__button");
...
const handleFormEditSubmit = async (evt) => {
  evt.preventDefault();
  renderLoading(true, editProfileFormBtn);
  editProfile({
    ...
    .finally(() => {
      renderLoading(false, editProfileFormBtn);
    });
};
...
const handleAvatarFormSubmit = async (evt) => {
  evt.preventDefault();
  renderLoading(true, avatarFormBtn);
  editAvatar(formElementAvatar.link.value)
    ...
    .finally(() => {
      renderLoading(false, avatarFormBtn);
    });
};
...
const handleAddCardFormSubmit = async (evt) => {
  evt.preventDefault();
  renderLoading(true, cardFormBtn);
  ...
  createNewCard({ name, link })
    ...
    .finally(() => {
      renderLoading(false, cardFormBtn);
    });
};
